...
public record TotalResponseDto(
        List<CommonResponseDto> commonResponseDtos, //카테고리별 장소들 설명, 및 이미지 파일 차후에 map으로 바꿔서 key값으로 찾게하려고
        Map<String, List<DayMap.Content>> result, //front에서 받은 장소들 greedy알고리즘 사용해서 나온 순서대로 리턴
